...
detector = cv2.FaceDetectorYN.create(
    "./FaceDetection/model/face_detection_yunet_2022mar.onnx",
    "",
    (320, 320),
    0.9,
    0.3,
...
recognizer = cv2.FaceRecognizerSF.create(
    "./FaceDetection/model/face_recognition_sface_2021dec.onnx", "")


def train():
    metadata = load_metadata('./FaceDetection/data')
    ...
    joblib.dump(svc, './FaceDetection/model/svc.pkl')
